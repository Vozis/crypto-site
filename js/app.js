(() => {
            ...
            function getHeight(showMoreBlock, showMoreContent) {
                ...
                if ("items" === showMoreType) {
                    ...
                    for (let index = 1; index < showMoreItems.length; index++) {
                        ...
                        hiddenHeight += showMoreItem.offsetHeight + 10;
    ...
    function initSliders() {
        ...
        if (document.querySelector(".features__slider--center")) new core(".features__slider--center", {
            freeMode: true,
            autoplay: {
                delay: 1e3,
                stopOnLastSlide: false,
    ...
    let menuEl = document.querySelector(".menu-burger__body");
    ...
    document.querySelectorAll(".menu__list-link").forEach((link => {
        if (link.href.includes(`${activePage}`)) link.classList.add("_active");
    }));
    document.addEventListener("click", documentActions);
    function documentActions(e) {
        e.target;
    }
    if (document.querySelector(".advantages-tree__block--5")) {
        const advantagesButtonMore = document.querySelector(".advantages-tree__block--5");
        const showMoreList = document.querySelector(".advantages__list");
        advantagesButtonMore.addEventListener("mouseover", (() => {
            document.querySelector(".color-path").classList.add("test-animation");
        }));
        advantagesButtonMore.addEventListener("click", (() => {
            showMoreList.classList.toggle("_active");
            _slideToggle(showMoreList);
        }));
    }
    if (document.querySelector(".top-hedging__tippy--other")) {
        const otherButton = document.querySelector(".top-hedging__tippy--other");
        const otherList = document.querySelector(".top-hedging__list");
        otherButton.addEventListener("click", (() => {
            otherList.classList.toggle("_active");
            _slideToggle(otherList);
        }));
    }
    window["FLS"] = true;
    isWebp();
